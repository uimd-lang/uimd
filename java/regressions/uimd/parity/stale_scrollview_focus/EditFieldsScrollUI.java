...
public class EditFieldsScrollUI extends GeneratedScrollViewBase
{

    public EditFieldsScrollUI()
    {
        super("Edit Fields Scroll");
    ...
    private static List<GeneratedLayoutEntry> buildLayout()
    {
        return List.of(
            new GeneratedLayoutEntry()
                ...
                .setSourceCell(new Rect(0, 0, 90, 19))
                ...
                .setCharsSize(new Size(90, 19))
                .setCellCharsSize(new Size(90, 19))
                .setMarginRight(0)
                .setMarginBottom(0)
