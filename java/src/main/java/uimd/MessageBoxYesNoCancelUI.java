...
public class MessageBoxYesNoCancelUI extends GeneratedWindowBase
{
    ...
    public MessageBoxYesNoCancelUI()
    {
        super("Message Box");
        ...
        setMcpMetadata(
            ...
            new GeneratedElementMetadata("yes_btn", "Yes", true),
            new GeneratedElementMetadata("no_btn", "No", true),
            new GeneratedElementMetadata("cancel_btn", "Cancel", true)));
        ...
        yes_btn.setStyle(Style.fromProperties("background", "#334155", "color", "#e2e8f0"));
        yes_btn.setFocusStyle(Style.fromProperties("background", "#2b5f9f", "color", "#ffffff"));
        yes_btn.setDisabledStyle(Style.fromProperties("background", "#1f2937", "color", "#64748b"));
        no_btn = addElement(new Button("no_btn", "No"));
        no_btn.setStyle(Style.fromProperties("background", "#334155", "color", "#e2e8f0"));
        no_btn.setFocusStyle(Style.fromProperties("background", "#2b5f9f", "color", "#ffffff"));
        no_btn.setDisabledStyle(Style.fromProperties("background", "#1f2937", "color", "#64748b"));
    ...
    private static List<GeneratedLayoutEntry> buildLayout()
    {
        return List.of(
            ...
            new GeneratedLayoutEntry()
                ...
                .setSourceCell(new Rect(2, 0, 46, 6))
                .setWidth(AxisDimension.expanded())
                .setHeight(AxisDimension.auto(2))
                .setCellWidth(AxisDimension.auto(46))
                .setCellHeight(AxisDimension.auto(6))
                .setCharsSize(new Size(42, 2))
                .setCellCharsSize(new Size(46, 6))
                .setMarginRight(2)
                .setMarginBottom(3)
                .setCellStyle(new Style())
            ...
            new GeneratedLayoutEntry()
                ...
                .setType("button")
                .setCellName("")
                .setRelative(new Rect(4, 16, 13, 1))
                .setSourceCell(new Rect(2, 0, 46, 6))
            ...
            new GeneratedLayoutEntry()
                ...
                .setType("button")
                .setCellName("")
                .setRelative(new Rect(4, 31, 536870911, 1))
                .setSourceCell(new Rect(2, 0, 46, 6))
                .setWidth(AxisDimension.expanded())
                .setHeight(AxisDimension.auto(1))
                .setCellWidth(AxisDimension.auto(46))
    ...
    {
        if ("yes_btn".equals(name))
        {
            onYesBtnClick();
            return true;
        }
        if ("no_btn".equals(name))
        {
            onNoBtnClick();
            return true;
        }
