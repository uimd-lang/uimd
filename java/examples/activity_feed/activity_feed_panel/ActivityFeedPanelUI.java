...
public class ActivityFeedPanelUI extends GeneratedScrollViewBase
{

    public ActivityFeedPanelUI()
    {
        super("Activity Feed Panel");
        ...
        scrollView().setStyle(Style.fromProperties("background", "#00000000", "gap", "1", "padding-bottom", "1", "padding-left", "0", "padding-right", "0", "padding-top", "1"));
    ...
    private static List<GeneratedLayoutEntry> buildLayout()
    {
        return List.of(
            new GeneratedLayoutEntry()
                ...
                .setSourceCell(new Rect(0, 0, 54, 9))
