"""Auto-generated UI code for log_panel_ui.py - DO NOT EDIT MANUALLY."""

from uimd.runtime import UIScrollView



class LogPanelUI(UIScrollView):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Log Panel\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\nstatus: stable\ndescription: "Log Panel UI source."\ntags: [component]\n```\n\n## Definition\n\n```yaml\nextends: uiscrollview\n```\n\n## Style\n\n```yaml\nthis:\n  border-width: 0\n  background: transparent\n@panel:\n  background: transparent\n  gap: 0\n@log_normal:\n  background: transparent\n  color: "#dddddd"\n  user-select: text\n  word-wrap: false\n@log_assert_ok:\n  background: transparent\n  color: "#15803d"\n  user-select: text\n  word-wrap: false\n@log_assert_fail:\n  background: transparent\n  color: "#b91c1c"\n  user-select: text\n  word-wrap: false\n@log_result_ok:\n  background: transparent\n  color: "#22c55e"\n  user-select: text\n  word-wrap: false\n@log_result_fail:\n  background: transparent\n  color: "#ef4444"\n  user-select: text\n  word-wrap: false\n```\n\n## User Interface\n\n```ui\n+-panel-**------------------------------------------------------------------------------+\n|                                                                                       |\n|                                                                                       |\n|                                                                                       |\n|                                                                                       |\n|                                                                                       |\n|                                                                                       |\n|                                                                                       |\n|                                                                                       |\n|                                                                                       |\n*                                                                                       |\n+---------------------------------------------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Log Panel UI source.'}, 'elements': {}}
    _mcp_app_tools = {}
