...
class ImageListButtonUI : public ui::GeneratedWindowBase
{
public:
    ImageListButtonUI();
    ...
    ui::Image* prw_1 = nullptr;
    ui::Image* prw_2 = nullptr;
    ui::Image* prw_3 = nullptr;

protected:
    virtual void onPrw1Click();
    virtual void onPrw2Click();
    virtual void onPrw3Click();
