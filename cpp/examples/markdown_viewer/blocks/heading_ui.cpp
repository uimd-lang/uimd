...
+------------------------------------------------+
```
)UI_MCP_MD", "Heading UI source.", std::vector<ui::GeneratedElementMetadata>{ui::GeneratedElementMetadata{"heading_text", "heading_text", true}});
    ...
    heading_text = &static_cast<ui::Label&>(addElement<ui::Label>("heading_text", ""));
    heading_text->setStyle(makeStyle({{"color", "#dbeafe"}, {"user-select", "text"}}));
}

bool HeadingUI::shouldClose() const
{
    return false;
}

bool HeadingUI::handleGeneratedButton(std::string_view name)
{
    return false;
}

bool HeadingUI::handleGeneratedTextChanged(std::string_view name, std::string_view value)
{
    return false;
}

bool HeadingUI::handleGeneratedTextConfirmed(std::string_view name, std::string_view value)
{
    return false;
}

bool HeadingUI::handleGeneratedSelectionChanged(std::string_view name, const std::vector<std::string>& value)
{
    return false;
}

ui::GeneratedWindowRuntimeOptions HeadingUI::runtimeOptions()
{
