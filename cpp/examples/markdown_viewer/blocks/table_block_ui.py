...
class TableBlockUI(UIControl):
    ...
    _mcp_agent_metadata = {'window': {'description': 'Table Block UI source.'}, 'elements': {'kind': {'role': 'text', 'description': 'markdown table', 'expose': True}, 'table': {'role': 'text', 'description': 'table', 'expose': True}}}
    _mcp_app_tools = {}
