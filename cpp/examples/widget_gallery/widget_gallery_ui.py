...
class WidgetGalleryUI(UIWindow):
    ...
    _mcp_enabled = True
    _mcp_source_md = '# Widget Gallery\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: window\nstatus: stable\ndescription: "Widget Gallery UI source."\ntags: [example]\n```\n\n## Members\n\n```yaml\nheader:\n  type: label\n  text: "Widget Gallery"\n  expose: false\n\nclose_btn:\n  type: button\n  title: X\n\nplain_label:\n  type: label\n  text: "Plain label with inherited theme colors."\n\nselectable_label:\n  type: label\n  text: "Select this text with the mouse to test label selection."\n\nspans:\n  type: spanlabel\n  text: "span label"\n\nanimation:\n  type: label\n  text: "Animated label shows gradient-based rendering."\n\nname_label:\n  type: label\n  text: Name\n\nname_input:\n  type: textinput\n  value: "Ada Lovelace"\n  maxlength: 80\n\ncount_label:\n  type: label\n  text: Count\n\ncount_input:\n  type: numberinput\n  value: 3\n  step_size: 1\n  min_value: 0\n  max_value: 99\n  format_str: 0\n\nenabled_check:\n  type: checkbox\n  title: "Feature enabled"\n  value: 1\n\ntheme_label:\n  type: label\n  text: Theme\n\ntheme_combo:\n  type: combobox\n  options: [Dark, Light, Solarized]\n  selected_item: Dark\n\nmode_label:\n  type: label\n  text: Mode\n\nmode_list:\n  type: listbox\n  options: [Preview, Edit, Review, Publish, Archive]\n  selected_items: [Preview]\n  multiple: "false"\n\napply_btn:\n  type: button\n  title: Apply\n\nreset_btn:\n  type: button\n  title: Reset\n\nsummary:\n  type: label\n  text: "values:\\n  name: Ada Lovelace\\n  count: 3\\n  theme: Dark\\n  mode: Preview\\n  enabled: true"\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n@header:\n  text-align: center\n  background: "#18324f"\n  color: "#ffffff"\n@close_btn:\n  background: "#7f1d1d"\n  focus-background: "#dc2626"\n  color: "#ffffff"\n@title:\n  background: "#18324f"\n@selectable_label:\n  user-select: text\n  color: "#a7f3d0"\n@spans:\n  user-select: text\n  color: "#cbd5e1"\n@animation:\n  color: "#fbbf24"\n  text-color-gradient:\n    interval: 100\n    step: 1\n    segment-size: 1\n    colors: ["#00000099", "#00000066", "#00000033", "#00000011", "#00000000", "#00000000", "#00000000", "#00000000", "#00000000", "#00000000", "#00000000", "#00000000", "#00000000", "#00000011", "#00000033", "#00000066", "#00000099"]\ntextinput:\n  cursor-background: "#facc15"\n  cursor-color: "#111827"\nnumberinput:\n  cursor-background: "#facc15"\n  cursor-color: "#111827"\ncheckbox:\n  color: "#d1d5db"\n  checked-color: "#22c55e"\n  unchecked-color: "#f97316"\n@summary:\n  background: "#0d1524"\n  color: "#dbeafe"\n```\n\n## User Interface\n\n```ui\n+-title------------------------------------------------+\n| header................................ close_btn.....|\n+-label_section----------------------------------------+\n|                                                      |\n|  plain_label.......................................  |\n|                                                      |\n|  selectable_label..................................  |\n|                                                      |\n|  spans.............................................  |\n|                                                      |\n|  animation.........................................  |\n|                                                      |\n+-control_section-----------+--section2----------------+\n|  name_label               |  theme_label             |\n|  name_input.............  |   theme_combo..........  |\n|                           |                          |\n|  count_label              |  mode_label              |\n|  count_input............  |  mode_list.............  |\n|                           |  ......................  |\n|  enabled_check..........  |  ......................  |\n|                           |  ......................  |\n|                           |  ......................  |\n+---------------------------+--------------------------+\n|                                                      |\n|  summary...........................................  |\n|  ..................................................  |\n|  ..................................................  |\n|  ..................................................  |\n|  ..................................................  |\n|  ..................................................  |\n|                                                      |\n|  apply_btn..............  reset_btn................  |\n|                                                      |\n+------------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Widget Gallery UI source.'}, 'elements': {'header': {'role': 'text', 'description': 'Widget Gallery', 'expose': False}, 'close_btn': {'role': 'action', 'description': 'X', 'expose': True}, 'plain_label': {'role': 'text', 'description': 'Plain label with inherited theme colors.', 'expose': True}, 'selectable_label': {'role': 'text', 'description': 'Select this text with the mouse to test label selection.', 'expose': True}, 'spans': {'role': 'text', 'description': 'span label', 'expose': True}, 'animation': {'role': 'text', 'description': 'Animated label shows gradient-based rendering.', 'expose': True}, 'name_label': {'role': 'text', 'description': 'Name', 'expose': True}, 'name_input': {'role': 'input', 'description': 'name_input', 'expose': True}, 'count_label': {'role': 'text', 'description': 'Count', 'expose': True}, 'count_input': {'role': 'input', 'description': 'count_input', 'expose': True}, 'enabled_check': {'role': 'toggle', 'description': 'Feature enabled', 'expose': True}, 'theme_label': {'role': 'text', 'description': 'Theme', 'expose': True}, 'theme_combo': {'role': 'selection', 'description': 'theme_combo', 'expose': True}, 'mode_label': {'role': 'text', 'description': 'Mode', 'expose': True}, 'mode_list': {'role': 'selection', 'description': 'mode_list', 'expose': True}, 'apply_btn': {'role': 'action', 'description': 'Apply', 'expose': True}, 'reset_btn': {'role': 'action', 'description': 'Reset', 'expose': True}, 'summary': {'role': 'text', 'description': 'values:\n  name: Ada Lovelace\n  count: 3\n  theme: Dark\n  mode: Preview\n  enabled: true', 'expose': True}}}
    _mcp_app_tools = {}
