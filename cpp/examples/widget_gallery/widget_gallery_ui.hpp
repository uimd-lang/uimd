...
class WidgetGalleryUI : public ui::GeneratedWindowBase
{
public:
    WidgetGalleryUI();
    ...
    ui::Label* plain_label = nullptr;
    ui::Label* selectable_label = nullptr;
    ui::Label* spans = nullptr;
    ui::Label* animation = nullptr;
    ui::Label* name_label = nullptr;
    ui::TextInput* name_input = nullptr;
    ui::Label* count_label = nullptr;
    ui::NumberInput* count_input = nullptr;
    ui::CheckBox* enabled_check = nullptr;
    ui::Label* theme_label = nullptr;
    ui::ComboBox* theme_combo = nullptr;
    ui::Label* mode_label = nullptr;
    ui::ListBox* mode_list = nullptr;
    ui::Button* apply_btn = nullptr;
    ui::Button* reset_btn = nullptr;
    ui::Label* summary = nullptr;
...
protected:
    ...
    virtual void onCountInputChange(std::string_view value);
    virtual void onCountInputSubmit(std::string_view value);
