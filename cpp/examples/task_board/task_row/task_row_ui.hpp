...
class TaskRowUI : public ui::GeneratedWindowBase
{
public:
    TaskRowUI();
    ...
    ui::Label* task_title = nullptr;
    ui::Label* meta = nullptr;
    ui::CheckBox* done = nullptr;
    ui::Label* spacer = nullptr;
    ui::Button* open_btn = nullptr;
    ui::Button* delete_btn = nullptr;

protected:
    virtual void onDoneChange(std::string_view value);
