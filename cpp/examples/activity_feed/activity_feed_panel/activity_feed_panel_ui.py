"""Auto-generated UI code for activity_feed_panel_ui.py - DO NOT EDIT MANUALLY."""

from runtime import UIScrollView

import sys
import os
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), '../activity_item'))


class ActivityFeedPanelUI(UIScrollView):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Activity Feed Panel\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\nstatus: draft\ndescription: "Reusable scroll view for activity feed items."\ntags: [component]\n```\n\n## Definition\n\n```yaml\nextends: uiscrollview\nuses:\n  - ../activity_item/activity_item\n```\n\n## Style\n\n```yaml\nthis:\n  border-width: 0\n  background: "#00000000"\n@panel:\n  gap: 1\n  padding: 1, 0, 1, 0\n  background: "#00000000"\n```\n\n## User Interface\n\n```ui\n+-panel-**---------------------------------------------+\n|                                                      |\n|                                                      |\n|                                                      |\n|                                                      |\n|                                                      |\n*                                                      |\n*                                                      |\n*                                                      |\n|                                                      |\n+------------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Reusable scroll view for activity feed items.'}, 'elements': {}}
    _mcp_app_tools = {}
