...
class ContactsManagerUI : public ui::GeneratedWindowBase
{
public:
    ContactsManagerUI();
    ...
    ui::Label* contacts_label = nullptr;
    ui::ListBox* contacts = nullptr;
    ui::Label* detail = nullptr;
    ui::Button* add_btn = nullptr;
    ui::Button* edit_btn = nullptr;
    ui::Button* delete_btn = nullptr;
    ui::Button* save_btn = nullptr;
    ui::Button* reload_btn = nullptr;
    ui::Button* close_btn = nullptr;
    ui::Label* status = nullptr;

protected:
    virtual void onContactsSelectionChange(const std::vector<std::string>& value);
    virtual bool onContactsItemActivate(int index, std::string_view value);
    virtual void onAddBtnClick();
    virtual void onEditBtnClick();
    virtual void onDeleteBtnClick();
    virtual void onSaveBtnClick();
    virtual void onReloadBtnClick();
