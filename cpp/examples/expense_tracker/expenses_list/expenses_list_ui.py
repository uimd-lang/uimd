"""Auto-generated UI code for expenses_list_ui.py - DO NOT EDIT MANUALLY."""

from runtime import UIScrollView

import sys
import os
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), '../expense_row'))


class ExpensesListUI(UIScrollView):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Expenses List\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\nstatus: experimental\ndescription: "Scrollable list of interactive expense rows."\ntags: [component, example]\n```\n\n## Definition\n\n```yaml\nextends: uiscrollview\nuses:\n  - ../expense_row/expense_row\n```\n\n## Style\n\n```yaml\nthis:\n  border-width: 0\n  background: "#18364d"\n@panel:\n  gap: 1\n  padding: 1\n  background: "#18364d"\n```\n\n## User Interface\n\n```ui\n+-panel-**---------------------------------------------+\n|                                                      |\n|                                                      |\n|                                                      |\n|                                                      |\n*                                                      |\n*                                                      |\n|                                                      |\n+------------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Scrollable list of interactive expense rows.'}, 'elements': {}}
    _mcp_app_tools = {}
