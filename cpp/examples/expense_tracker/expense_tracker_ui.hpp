...
class ExpenseTrackerUI : public ui::GeneratedWindowBase
{
public:
    ExpenseTrackerUI();
    ...
    ui::Label* app_title = nullptr;
    ui::Button* quit_btn = nullptr;
    ui::Label* nav_title = nullptr;
    ui::Button* expenses_btn = nullptr;
    ui::Button* categories_btn = nullptr;
    ui::Button* settings_btn = nullptr;
    ui::ViewHost* main = nullptr;

protected:
    virtual void onQuitBtnClick();
    virtual void onExpensesBtnClick();
    virtual void onCategoriesBtnClick();
    virtual void onSettingsBtnClick();
