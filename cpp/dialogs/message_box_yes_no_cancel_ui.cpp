...
{
    return {
        ui::GeneratedLayoutEntry{.name = "dialog_header", .type = "label", .cellName = "", .relative = ui::Rect{0, 0, 536870911, 1}, .sourceCell = ui::Rect{0, 0, 46, 1}, .width = dimension("expanded", 536870911), .height = dimension("auto", 1), .cellWidth = dimension("auto", 46), .cellHeight = dimension("auto", 1), .charsSize = ui::Size{46, 1}, .cellCharsSize = ui::Size{46, 1}, .marginRight = 0, .marginBottom = 0, .elementStyle = makeStyle({{"background", "#1d314c"}, {"color", "#cbd5e1"}, {"text-align", "center"}})},
        ui::GeneratedLayoutEntry{.name = "message", .type = "label", .cellName = "", .relative = ui::Rect{1, 2, 536870911, 2}, .sourceCell = ui::Rect{2, 0, 46, 6}, .width = dimension("expanded", 536870911), .height = dimension("auto", 2), .cellWidth = dimension("auto", 46), .cellHeight = dimension("auto", 6), .charsSize = ui::Size{42, 2}, .cellCharsSize = ui::Size{46, 6}, .marginRight = 2, .marginBottom = 3, .elementStyle = makeStyle({{"background", "transparent"}, {"color", "#cbd5e1"}})},
        ui::GeneratedLayoutEntry{.name = "yes_btn", .type = "button", .cellName = "", .relative = ui::Rect{4, 2, 12, 1}, .sourceCell = ui::Rect{2, 0, 46, 6}, .width = dimension("auto", 12), .height = dimension("auto", 1), .cellWidth = dimension("auto", 46), .cellHeight = dimension("auto", 6), .charsSize = ui::Size{12, 1}, .cellCharsSize = ui::Size{46, 6}, .marginRight = 32, .marginBottom = 1, .elementStyle = makeStyle({{"background", "#334155"}, {"color", "#e2e8f0"}})},
        ui::GeneratedLayoutEntry{.name = "no_btn", .type = "button", .cellName = "", .relative = ui::Rect{4, 16, 13, 1}, .sourceCell = ui::Rect{2, 0, 46, 6}, .width = dimension("auto", 13), .height = dimension("auto", 1), .cellWidth = dimension("auto", 46), .cellHeight = dimension("auto", 6), .charsSize = ui::Size{13, 1}, .cellCharsSize = ui::Size{46, 6}, .marginRight = 17, .marginBottom = 1, .elementStyle = makeStyle({{"background", "#334155"}, {"color", "#e2e8f0"}})},
        ui::GeneratedLayoutEntry{.name = "cancel_btn", .type = "button", .cellName = "", .relative = ui::Rect{4, 31, 536870911, 1}, .sourceCell = ui::Rect{2, 0, 46, 6}, .width = dimension("expanded", 536870911), .height = dimension("auto", 1), .cellWidth = dimension("auto", 46), .cellHeight = dimension("auto", 6), .charsSize = ui::Size{13, 1}, .cellCharsSize = ui::Size{46, 6}, .marginRight = 2, .marginBottom = 1, .elementStyle = makeStyle({{"background", "#334155"}, {"color", "#e2e8f0"}})},
    };
}

}  // namespace

MessageBoxYesNoCancelUI::MessageBoxYesNoCancelUI() : ui::GeneratedWindowBase("Message Box")
{
    setGeneratedLayout(buildLayout());
    setGeneratedFocusable(false);
    setGeneratedKind("dialog");
    setMcpMetadata(true, "MessageBoxYesNoCancel", R"UI_MCP_MD(# Message Box
...
+----------------------------------------------+
```
)UI_MCP_MD", "Message Box UI source.", std::vector<ui::GeneratedElementMetadata>{ui::GeneratedElementMetadata{"dialog_header", "Message", true}, ui::GeneratedElementMetadata{"message", "message", true}, ui::GeneratedElementMetadata{"yes_btn", "Yes", true}, ui::GeneratedElementMetadata{"no_btn", "No", true}, ui::GeneratedElementMetadata{"cancel_btn", "Cancel", true}});
...
void MessageBoxYesNoCancelUI::onYesBtnClick()
{
}

void MessageBoxYesNoCancelUI::onNoBtnClick()
{
}

void MessageBoxYesNoCancelUI::onCancelBtnClick()
{
}

bool MessageBoxYesNoCancelUI::shouldClose() const
{
    return false;
}
...
ui::GeneratedWindowRuntimeOptions MessageBoxYesNoCancelUI::runtimeOptions()
{
