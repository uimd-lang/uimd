...
class MessageBoxYesNoUI : public ui::GeneratedWindowBase
{
public:
    MessageBoxYesNoUI();
    ...
    ui::Button* yes_btn = nullptr;
    ui::Button* no_btn = nullptr;

protected:
    virtual void onYesBtnClick();
    virtual void onNoBtnClick();
