...
+--------------------------------------------+
```
)UI_MCP_MD", "Message Box UI source.", std::vector<ui::GeneratedElementMetadata>{ui::GeneratedElementMetadata{"dialog_header", "Message", true}, ui::GeneratedElementMetadata{"message", "message", true}, ui::GeneratedElementMetadata{"ok_btn", "OK", true}, ui::GeneratedElementMetadata{"cancel_btn", "Cancel", true}});
...
void MessageBoxOkCancelUI::onOkBtnClick()
{
}

void MessageBoxOkCancelUI::onCancelBtnClick()
{
}

bool MessageBoxOkCancelUI::shouldClose() const
{
    return false;
}

bool MessageBoxOkCancelUI::handleGeneratedButton(std::string_view name)
{
    if (name == "ok_btn")
    {
        onOkBtnClick();
...
bool MessageBoxOkCancelUI::handleGeneratedTextChanged(std::string_view name, std::string_view value)
{
    return false;
}

bool MessageBoxOkCancelUI::handleGeneratedTextConfirmed(std::string_view name, std::string_view value)
{
    return false;
}

bool MessageBoxOkCancelUI::handleGeneratedSelectionChanged(std::string_view name, const std::vector<std::string>& value)
{
    return false;
}

ui::GeneratedWindowRuntimeOptions MessageBoxOkCancelUI::runtimeOptions()
{
