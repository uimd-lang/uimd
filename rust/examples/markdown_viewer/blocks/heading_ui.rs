...
pub struct HeadingUI
{
    pub base: uimd::GeneratedWindow,
    pub heading_text: uimd::SpanLabelRef,
}
...
impl HeadingUI
{
    pub fn new() -> Self
    {
        let mut base = uimd::GeneratedWindow::new("Heading");
        ...
        uimd::LayoutItem {
            ...
            cell_name: "heading_cell".to_string(), cell_width: 0, cell_height: 1,
        ...
        base.set_generated_named_style("heading_cell", uimd::Style {
        background: Some(uimd::Color::new("#00000000")),
        ..Default::default()
    });
        base.set_generated_named_style("heading_text", uimd::Style {
        color: Some(uimd::Color::new("#dbeafe")),
        user_select: Some("text".to_string()),
        ..Default::default()
    });
        base.set_mcp_metadata(true, "Heading", "# Heading\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\nstatus: stable\ndescription: \"Reusable markdown heading block.\"\ntags: [component]\n```\n\n## Definition\n\n```yaml\nextends: uicontrol\n```\n\n## Members\n\n```yaml\nheading_text:\n  type: spanlabel\n  text: \"\"\n  description: \"Rendered heading text with mouse selection enabled.\"\n```\n\n## Style\n\n```yaml\nthis:\n  background: \"#00000000\"\n  border-width: 0\n@heading_cell:\n  background: \"#00000000\"\n@heading_text:\n  color: \"#dbeafe\"\n  user-select: text\n```\n\n## User Interface\n\n```ui\n+-heading_cell-**--------------------------------+\n| heading_text..**.............................. |\n+------------------------------------------------+\n```\n", "Reusable markdown heading block.");
        base.set_mcp_element_metadata(vec![uimd::GeneratedElementMetadata::new("heading_text", "Rendered heading text with mouse selection enabled.", true)]);
        base.set_mcp_app_tools(vec![]);
        let heading_text = uimd::new_span_label("heading_text", "");
        base.add_element(heading_text.clone());
        heading_text.borrow_mut().set_style(uimd::Style {
        color: Some(uimd::Color::new("#dbeafe")),
        user_select: Some("text".to_string()),
        ..Default::default()
    });
    ...
    pub fn run<H: HeadingUIEvents>(&mut self, handler: &mut H, args: &[String]) -> i32
    {
        let options = self.base.runtime_options();
        let mut runtime = HeadingUIRuntime { ui: self, handler };
        uimd::run_generated_window(&mut runtime, options, args)
    }
}

impl Default for HeadingUI
{
    fn default() -> Self { Self::new() }
}

pub trait HeadingUIEvents
{
    fn handle_dynamic_button(&mut self, _ui: &mut HeadingUI, _name: &str) -> bool { false }
    fn handle_dynamic_text_changed(&mut self, _ui: &mut HeadingUI, _name: &str, _value: &str) -> bool { false }
    fn handle_dynamic_text_confirmed(&mut self, _ui: &mut HeadingUI, _name: &str, _value: &str) -> bool { false }
    fn handle_dynamic_selection_changed(&mut self, _ui: &mut HeadingUI, _name: &str, _value: &[String]) -> bool { false }
    fn handle_active_window_button(&mut self, _ui: &mut HeadingUI, _name: &str) -> bool { false }
    fn on_focus_changed(&mut self, _ui: &mut HeadingUI, _name: &str, _focused: bool) {}
    fn on_preview_key(&mut self, _ui: &mut HeadingUI, _event: &uimd::KeyEvent) -> bool { false }
    #[deprecated(since = "0.5.4", note = "use on_preview_key; removal in UIMD 0.7.0")]
    fn handle_key_before_focused(&mut self, _ui: &mut HeadingUI, _key: &str, _name: &str, _edit_mode: bool) -> bool { false }
    fn handle_key(&mut self, _ui: &mut HeadingUI, _key: &str) -> bool { false }
    fn on_window_closed(&mut self, _ui: &mut HeadingUI, _window: uimd::GeneratedWindow) {}
    fn mcp_tool_names(&self) -> Vec<String> { Vec::new() }
    fn handle_mcp_tool(&mut self, _ui: &mut HeadingUI, _name: &str, _arguments: &Map<String, Value>) -> Option<Value> { None }
}

struct HeadingUIRuntime<'a, H: HeadingUIEvents>
{
    ui: &'a mut HeadingUI,
    handler: &'a mut H,
}

impl<H: HeadingUIEvents> uimd::GeneratedApplication for HeadingUIRuntime<'_, H>
{
