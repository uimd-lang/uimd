// Auto-generated UI code for message_box_ok_cancel - DO NOT EDIT MANUALLY.
#![allow(clippy::too_many_lines, dead_code, unused_variables)]

use serde_json::{Map, Value};

pub struct MessageBoxOkCancelUI
{
...
impl MessageBoxOkCancelUI
{
    pub fn new() -> Self
    {
        ...
        base.set_mcp_metadata(true, "MessageBoxOkCancel", "# Message Box\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: dialog\nstatus: stable\ndescription: \"Message Box UI source.\"\ntags: [dialog]\n```\n\n## Members\n\n```yaml\ndialog_header:\n  type: label\n  text: Message\n\nmessage:\n  type: label\n  text: \"\"\n\nok_btn:\n  type: button\n  title: OK\n\ncancel_btn:\n  type: button\n  title: Cancel\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n```\n\n## User Interface\n\n```ui\n+--------------------------------------------+\n|dialog_header...............................|\n+--------------------------------------------+\n|                                            |\n|  message.................................  |\n|  ........................................  |\n|                                            |\n|   ok_btn............  cancel_btn........   |\n|                                            |\n+--------------------------------------------+\n```\n", "Message Box UI source.");
        base.set_mcp_element_metadata(vec![uimd::GeneratedElementMetadata::new("dialog_header", "Message", true), uimd::GeneratedElementMetadata::new("message", "message", true), uimd::GeneratedElementMetadata::new("ok_btn", "OK", true), uimd::GeneratedElementMetadata::new("cancel_btn", "Cancel", true)]);
    ...
    pub fn run<H: MessageBoxOkCancelUIEvents>(&mut self, handler: &mut H, args: &[String]) -> i32
    {
        let options = self.base.runtime_options();
        let mut runtime = MessageBoxOkCancelUIRuntime { ui: self, handler };
        uimd::run_generated_window(&mut runtime, options, args)
    }
}

impl Default for MessageBoxOkCancelUI
{
    fn default() -> Self { Self::new() }
}

pub trait MessageBoxOkCancelUIEvents
{
    fn on_ok_btn_click(&mut self, _ui: &mut MessageBoxOkCancelUI) {}
    fn on_cancel_btn_click(&mut self, _ui: &mut MessageBoxOkCancelUI) {}
    fn handle_dynamic_button(&mut self, _ui: &mut MessageBoxOkCancelUI, _name: &str) -> bool { false }
    fn handle_dynamic_text_changed(&mut self, _ui: &mut MessageBoxOkCancelUI, _name: &str, _value: &str) -> bool { false }
    fn handle_dynamic_text_confirmed(&mut self, _ui: &mut MessageBoxOkCancelUI, _name: &str, _value: &str) -> bool { false }
    fn handle_dynamic_selection_changed(&mut self, _ui: &mut MessageBoxOkCancelUI, _name: &str, _value: &[String]) -> bool { false }
    fn on_focus_changed(&mut self, _ui: &mut MessageBoxOkCancelUI, _name: &str, _focused: bool) {}
    fn handle_key_before_focused(&mut self, _ui: &mut MessageBoxOkCancelUI, _key: &str, _name: &str, _edit_mode: bool) -> bool { false }
    fn handle_key(&mut self, _ui: &mut MessageBoxOkCancelUI, _key: &str) -> bool { false }
    fn on_window_closed(&mut self, _ui: &mut MessageBoxOkCancelUI, _window: uimd::GeneratedWindow) {}
    fn mcp_tool_names(&self) -> Vec<String> { Vec::new() }
    fn handle_mcp_tool(&mut self, _ui: &mut MessageBoxOkCancelUI, _name: &str, _arguments: &Map<String, Value>) -> Option<Value> { None }
}

struct MessageBoxOkCancelUIRuntime<'a, H: MessageBoxOkCancelUIEvents>
{
    ui: &'a mut MessageBoxOkCancelUI,
    handler: &'a mut H,
}

impl<H: MessageBoxOkCancelUIEvents> uimd::GeneratedApplication for MessageBoxOkCancelUIRuntime<'_, H>
{
