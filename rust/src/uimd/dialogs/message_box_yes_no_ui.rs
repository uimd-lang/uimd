// Auto-generated UI code for message_box_yes_no - DO NOT EDIT MANUALLY.
#![allow(clippy::too_many_lines, dead_code, unused_variables)]

use serde_json::{Map, Value};

pub struct MessageBoxYesNoUI
{
...
impl MessageBoxYesNoUI
{
    pub fn new() -> Self
    {
        ...
        base.set_mcp_metadata(true, "MessageBoxYesNo", "# Message Box\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: dialog\nstatus: stable\ndescription: \"Message Box UI source.\"\ntags: [dialog]\n```\n\n## Members\n\n```yaml\ndialog_header:\n  type: label\n  text: Message\n\nmessage:\n  type: label\n  text: \"\"\n\nyes_btn:\n  type: button\n  title: \"Yes\"\n\nno_btn:\n  type: button\n  title: \"No\"\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n```\n\n## User Interface\n\n```ui\n+--------------------------------------------+\n|dialog_header...............................|\n+--------------------------------------------+\n|                                            |\n|  message.................................  |\n|  ........................................  |\n|                                            |\n|   yes_btn...........  no_btn............   |\n|                                            |\n+--------------------------------------------+\n```\n", "Message Box UI source.");
        base.set_mcp_element_metadata(vec![uimd::GeneratedElementMetadata::new("dialog_header", "Message", true), uimd::GeneratedElementMetadata::new("message", "message", true), uimd::GeneratedElementMetadata::new("yes_btn", "Yes", true), uimd::GeneratedElementMetadata::new("no_btn", "No", true)]);
    ...
    pub fn run<H: MessageBoxYesNoUIEvents>(&mut self, handler: &mut H, args: &[String]) -> i32
    {
        let options = self.base.runtime_options();
        let mut runtime = MessageBoxYesNoUIRuntime { ui: self, handler };
        uimd::run_generated_window(&mut runtime, options, args)
    }
}

impl Default for MessageBoxYesNoUI
{
    fn default() -> Self { Self::new() }
}

pub trait MessageBoxYesNoUIEvents
{
    fn on_yes_btn_click(&mut self, _ui: &mut MessageBoxYesNoUI) {}
    fn on_no_btn_click(&mut self, _ui: &mut MessageBoxYesNoUI) {}
    fn handle_dynamic_button(&mut self, _ui: &mut MessageBoxYesNoUI, _name: &str) -> bool { false }
    fn handle_dynamic_text_changed(&mut self, _ui: &mut MessageBoxYesNoUI, _name: &str, _value: &str) -> bool { false }
    fn handle_dynamic_text_confirmed(&mut self, _ui: &mut MessageBoxYesNoUI, _name: &str, _value: &str) -> bool { false }
    fn handle_dynamic_selection_changed(&mut self, _ui: &mut MessageBoxYesNoUI, _name: &str, _value: &[String]) -> bool { false }
    fn on_focus_changed(&mut self, _ui: &mut MessageBoxYesNoUI, _name: &str, _focused: bool) {}
    fn handle_key_before_focused(&mut self, _ui: &mut MessageBoxYesNoUI, _key: &str, _name: &str, _edit_mode: bool) -> bool { false }
    fn handle_key(&mut self, _ui: &mut MessageBoxYesNoUI, _key: &str) -> bool { false }
    fn on_window_closed(&mut self, _ui: &mut MessageBoxYesNoUI, _window: uimd::GeneratedWindow) {}
    fn mcp_tool_names(&self) -> Vec<String> { Vec::new() }
    fn handle_mcp_tool(&mut self, _ui: &mut MessageBoxYesNoUI, _name: &str, _arguments: &Map<String, Value>) -> Option<Value> { None }
}

struct MessageBoxYesNoUIRuntime<'a, H: MessageBoxYesNoUIEvents>
{
    ui: &'a mut MessageBoxYesNoUI,
    handler: &'a mut H,
}

impl<H: MessageBoxYesNoUIEvents> uimd::GeneratedApplication for MessageBoxYesNoUIRuntime<'_, H>
{
