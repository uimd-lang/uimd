...
func NewGalleryItemUI() *GalleryItemUI {
    ui := &GalleryItemUI{GeneratedWindowBase: uimd.NewGeneratedWindowBase("Gallery Item")}
    ui.SetGeneratedLayout([]uimd.LayoutItem{
        {
            Row: 0, Col: 1,
            CellRow: 0, CellCol: 0,
            CellCharsWidth: 34, CellCharsHeight: 21,
            CellName: "view", CellWidth: 0, CellHeight: 21,
...
func (ui *GalleryItemUI) SetEventHandler(handler any) {
    ui.eventHandler = handler
}

func (ui *GalleryItemUI) HandleGeneratedButton(name string) bool {
    if name == "photo" {
...
func (ui *GalleryItemUI) HandleGeneratedTextChanged(name string, value string) bool {
    return false
}

func (ui *GalleryItemUI) HandleGeneratedTextConfirmed(name string, value string) bool {
    return false
}

func (ui *GalleryItemUI) HandleGeneratedSelectionChanged(name string, value []string) bool {
    return false
}

func (ui *GalleryItemUI) HandleGeneratedPreviewKey(event uimd.KeyEvent) bool {
...
func (ui *GalleryItemUI) HandleGeneratedKey(key string) bool {
