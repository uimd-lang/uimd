...
open class MessageBoxYesNoUI: GeneratedWindowBase
{
    ...
    public init()
    {
        ...
        setMcpMetadata(enabled: true, className: "MessageBoxYesNo", source: "# Message Box\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: dialog\nstatus: stable\ndescription: \"Message Box UI source.\"\ntags: [dialog]\n```\n\n## Members\n\n```yaml\ndialog_header:\n  type: label\n  text: Message\n\nmessage:\n  type: label\n  text: \"\"\n\nyes_btn:\n  type: button\n  title: \"Yes\"\n\nno_btn:\n  type: button\n  title: \"No\"\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n```\n\n## User Interface\n\n```ui\n+--------------------------------------------+\n|dialog_header...............................|\n+--------------------------------------------+\n|                                            |\n|  message.................................  |\n|  ........................................  |\n|                                            |\n|   yes_btn...........  no_btn............   |\n|                                            |\n+--------------------------------------------+\n```\n", description: "Message Box UI source.")
        setMcpAppTools([])
    ...
    private static func buildLayout() -> [GeneratedLayoutEntry]
    {
        return [
            GeneratedLayoutEntry(
                ...
                sourceCell: Rect(row: 0, col: 0, width: 44, height: 1),
                width: .expanded,
                height: .auto(1),
                cellWidth: .auto(44),
                cellHeight: .auto(1),
                charsSize: Size(width: 44, height: 1),
                cellCharsSize: Size(width: 44, height: 1),
                marginRight: 0,
                marginBottom: 0,
                cellStyle: Style(),
                elementStyle: {
            ...
            GeneratedLayoutEntry(
                ...
                sourceCell: Rect(row: 2, col: 0, width: 44, height: 6),
                width: .expanded,
                height: .auto(2),
                cellWidth: .auto(44),
                cellHeight: .auto(6),
                charsSize: Size(width: 40, height: 2),
                cellCharsSize: Size(width: 44, height: 6),
                marginRight: 2,
                marginBottom: 3,
                cellStyle: Style(),
                elementStyle: {
            ...
            GeneratedLayoutEntry(
                ...
                type: "button",
                cellName: "",
                relative: Rect(row: 4, col: 3, width: 18, height: 1),
                sourceCell: Rect(row: 2, col: 0, width: 44, height: 6),
                width: .auto(18),
                height: .auto(1),
                cellWidth: .auto(44),
            ...
            GeneratedLayoutEntry(
                ...
                type: "button",
                cellName: "",
                relative: Rect(row: 4, col: 23, width: 536870911, height: 1),
                sourceCell: Rect(row: 2, col: 0, width: 44, height: 6),
                width: .expanded,
                height: .auto(1),
                cellWidth: .auto(44),
