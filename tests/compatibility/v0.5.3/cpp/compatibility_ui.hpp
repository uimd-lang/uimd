...
class CompatibilityUI : public ui::GeneratedWindowBase
{
public:
    CompatibilityUI();
    ...
    ui::TextInput* aligned_input = nullptr;
    ui::ComboBox* choice = nullptr;
    ui::ReusableElement* scroller = nullptr;

protected:
    virtual void onAlignedInputChange(std::string_view value);
    virtual void onAlignedInputSubmit(std::string_view value);
    virtual void onChoiceChange(std::string_view value);
