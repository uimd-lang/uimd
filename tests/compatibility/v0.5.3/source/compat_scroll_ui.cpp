...
CompatScrollUI::CompatScrollUI() : ui::GeneratedScrollViewBase("UIMD 0.5.3 Compatibility Scroll")
{
    setGeneratedLayout(buildLayout());
    setGeneratedFocusable(false);
    setGeneratedKind("component");
    setMcpMetadata(true, "CompatScroll", R"UI_MCP_MD(# UIMD 0.5.3 Compatibility Scroll
...
+------------------------------+
```
)UI_MCP_MD", "Retained generated ScrollView input for the 0.5.3 patch-compatibility gate.", std::vector<ui::GeneratedElementMetadata>{ui::GeneratedElementMetadata{"alpha_row", "legacy alpha row", true}});
    ...
    scrollView().setStyle(makeStyle({{"background", "#303545"}, {"padding", "0"}}));
    ...
    alpha_row = &static_cast<ui::Label&>(addElement<ui::Label>("alpha_row", "legacy alpha row"));
    alpha_row->setStyle(makeStyle({{"background", "#252a36cc"}, {"color", "#cbd5e1"}}));
    alpha_row->setCursorStyle(makeStyle({{"background", "#b8d7ff"}, {"color", "#000000"}}));
}

bool CompatScrollUI::shouldClose() const
{
    return false;
}

bool CompatScrollUI::handleGeneratedButton(std::string_view name)
{
    (void)name;
    return false;
}

bool CompatScrollUI::handleGeneratedTextChanged(std::string_view name, std::string_view value)
{
    (void)name;
    (void)value;
    return false;
...
bool CompatScrollUI::handleGeneratedTextConfirmed(std::string_view name, std::string_view value)
{
    (void)name;
    (void)value;
    return false;
...
bool CompatScrollUI::handleGeneratedSelectionChanged(std::string_view name, const std::vector<std::string>& value)
{
    (void)name;
    (void)value;
    return false;
...
ui::GeneratedWindowRuntimeOptions CompatScrollUI::runtimeOptions()
{
