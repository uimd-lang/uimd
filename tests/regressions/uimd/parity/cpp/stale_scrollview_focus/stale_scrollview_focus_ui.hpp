...
class StaleScrollviewFocusUI : public ui::GeneratedWindowBase
{
public:
    ...
    ui::Button* tab_list = nullptr;
    ui::Button* tab_other = nullptr;
    ui::Label* hint = nullptr;
    ui::ViewHost* page = nullptr;

protected:
    virtual void onQuitBtnClick();
    virtual void onTabListClick();
    virtual void onTabOtherClick();
