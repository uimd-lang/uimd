"""Auto-generated UI code for source_separator_scroll_ui.py - DO NOT EDIT MANUALLY."""

from uimd.runtime import UIScrollView



class SourceSeparatorScrollUI(UIScrollView):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Source Separator Scroll\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: window\nstatus: regression\ndescription: "ScrollView regression for reusable children whose source rows include design-only separators."\ntags: [regression, issue-3, scrollview]\n```\n\n## Definition\n\n```yaml\nextends: uiscrollview\nuses:\n  - source_separator_row\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n  background: "#030712"\n@panel:\n  gap: 0\n  padding: 0\n  background: "#030712"\n```\n\n## User Interface\n\n```ui\n+-panel-**----+\n|             |\n|             |\n|             |\n|             |\n+-------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'ScrollView regression for reusable children whose source rows include design-only separators.'}, 'elements': {}}
    _mcp_app_tools = {}

    def __init__(self):
        super().__init__(
            title="Source Separator Scroll",
