"""Auto-generated UI code for edit_fields_scroll_ui.py - DO NOT EDIT MANUALLY."""

from uimd.runtime import UIScrollView



class EditFieldsScrollUI(UIScrollView):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Edit Fields Scroll\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\nstatus: regression\ndescription: "Scrollable edit form body populated with many text inputs and buttons."\ntags: [regression, issue-5, scrollview]\n```\n\n## Definition\n\n```yaml\nextends: uiscrollview\nuses:\n  - edit_field_row\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n  background: "#030712"\n@panel:\n  gap: 1\n  padding: 1, 1, 1, 1\n  background: "#030712"\n```\n\n## User Interface\n\n```ui\n+-panel-**---------------------------------------------------------------------------------+\n|                                                                                          |\n*                                                                                          |\n*                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n+------------------------------------------------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Scrollable edit form body populated with many text inputs and buttons.'}, 'elements': {}}
    _mcp_app_tools = {}

    def __init__(self):
        super().__init__(
            title="Edit Fields Scroll",
