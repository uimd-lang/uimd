"""Auto-generated UI code for list_page_ui.py - DO NOT EDIT MANUALLY."""

from uimd.runtime import UIScrollView



class ListPageUI(UIScrollView):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# List Page\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\nstatus: regression\ndescription: "Scrollable list page with interactive row buttons for the ViewHost focus regression."\ntags: [regression, issue-5, scrollview]\n```\n\n## Definition\n\n```yaml\nextends: uiscrollview\nuses:\n  - item_row\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n  background: "#030712"\n@panel:\n  gap: 1\n  padding: 1, 1, 1, 1\n  background: "#030712"\n```\n\n## User Interface\n\n```ui\n+-panel-**---------------------------------------------------------------------------------+\n|                                                                                          |\n*                                                                                          |\n*                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n|                                                                                          |\n+------------------------------------------------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Scrollable list page with interactive row buttons for the ViewHost focus regression.'}, 'elements': {}}
    _mcp_app_tools = {}
