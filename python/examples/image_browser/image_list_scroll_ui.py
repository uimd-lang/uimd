"""Auto-generated UI code for image_list_scroll_ui.py - DO NOT EDIT MANUALLY."""

from uimd.runtime import UIScrollView



class ImageListScrollUI(UIScrollView):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Image List Scroll\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\ndescription: "Scrollable image item list."\ntags: [example, image, list]\n```\n\n## Definition\n\n```yaml\nextends: uiscrollview\nuses:\n  - image_list_item\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n  background: "#030712"\n  focus-background: "#1e3a5f"\n@panel:\n  gap: 1\n  padding: 1, 1, 1, 1\n  background: "#030712"\n```\n\n## User Interface\n\n```ui\n+-panel-**----------------------------------------------------------------+\n|                                                                         |\n|                                                                         |\n|                                                                         |\n|                                                                         |\n|                                                                         |\n*                                                                         |\n*                                                                         |\n*                                                                         |\n*                                                                         |\n|                                                                         |\n+-------------------------------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Scrollable image item list.'}, 'elements': {}}
    _mcp_app_tools = {}

    def __init__(self):
        super().__init__(
            title="Image List Scroll",
