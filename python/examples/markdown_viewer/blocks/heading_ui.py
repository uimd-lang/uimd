"""Auto-generated UI code for heading_ui.py - DO NOT EDIT MANUALLY."""

from uimd.runtime import UIControl



class HeadingUI(UIControl):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Heading\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\nstatus: stable\ndescription: "Reusable markdown heading block."\ntags: [component]\n```\n\n## Definition\n\n```yaml\nextends: uicontrol\n```\n\n## Members\n\n```yaml\nheading_text:\n  type: spanlabel\n  text: ""\n  description: "Rendered heading text with mouse selection enabled."\n```\n\n## Style\n\n```yaml\nthis:\n  background: "#00000000"\n  border-width: 0\n@heading_cell:\n  background: "#00000000"\n@heading_text:\n  color: "#dbeafe"\n  user-select: text\n```\n\n## User Interface\n\n```ui\n+-heading_cell-**--------------------------------+\n| heading_text..**.............................. |\n+------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Reusable markdown heading block.'}, 'elements': {'heading_text': {'role': 'text', 'description': 'Rendered heading text with mouse selection enabled.', 'expose': True}}}
    _mcp_app_tools = {}
    ...
    def __init__(self):
        ...
        self.heading_text = self.create_element("heading_text", "spanlabel", text='')
