...
class CodeBlockUI(UIControl):
    ...
    _mcp_agent_metadata = {'window': {'description': 'Reusable markdown code block with a language header and selectable code text.'}, 'elements': {'lang': {'role': 'text', 'description': 'Language label for the code block.', 'expose': True}, 'code': {'role': 'text', 'description': 'Rendered code content with horizontal preservation and mouse selection enabled.', 'expose': True}}}
    _mcp_app_tools = {}
