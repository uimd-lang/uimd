"""Auto-generated UI code for table_block_ui.py - DO NOT EDIT MANUALLY."""

from uimd.runtime import UIControl



class TableBlockUI(UIControl):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Table Block\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: component\nstatus: stable\ndescription: "Reusable markdown table block with a small header and message table content."\ntags: [component]\n```\n\n## Definition\n\n```yaml\nextends: uicontrol\n```\n\n## Members\n\n```yaml\nkind:\n  type: label\n  text: "markdown table"\n  description: "Header label identifying the block as a markdown table."\n\ntable:\n  type: messagetable\n  text: ""\n  description: "Rendered markdown table content."\n```\n\n## Style\n\n```yaml\nthis:\n  background: "#00000000"\n  border-width: 0\n@head:\n  background: "#1d314c"\n@body:\n  background: "#0c1a2d"\n@kind:\n  color: "#93c5fd"\n@table:\n  color: "#e5e7eb"\n```\n\n## User Interface\n\n```ui\n+-head-**----------------------------------------+\n| kind..**...................................... |\n+-body-**----------------------------------------+\n| table..**..................................... |\n| .............................................. |\n# #............................................ |\n# #............................................ |\n+------------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Reusable markdown table block with a small header and message table content.'}, 'elements': {'kind': {'role': 'text', 'description': 'Header label identifying the block as a markdown table.', 'expose': True}, 'table': {'role': 'text', 'description': 'Rendered markdown table content.', 'expose': True}}}
    _mcp_app_tools = {}
    ...
    def __init__(self):
        ...
        self.kind = self.create_element("kind", "label", text='markdown table')
        self.table = self.create_element("table", "messagetable", text='')
