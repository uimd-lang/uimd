"""Auto-generated UI code for message_box_ok_cancel_ui.py - DO NOT EDIT MANUALLY."""

from uimd.runtime import UIWindow



class MessageBoxOkCancelUI(UIWindow):
    """Generated UI window from markdown definition."""

    _mcp_enabled = True
    _mcp_source_md = '# Message Box\n\n## Metadata\n\n```yaml\nformat: uimd\nformat-version: 1\nkind: dialog\nstatus: stable\ndescription: "Message Box UI source."\ntags: [dialog]\n```\n\n## Members\n\n```yaml\ndialog_header:\n  type: label\n  text: Message\n\nmessage:\n  type: label\n  text: ""\n\nok_btn:\n  type: button\n  title: OK\n\ncancel_btn:\n  type: button\n  title: Cancel\n```\n\n## Style\n\n```yaml\ninclude: dark\nthis:\n  border-width: 0\n```\n\n## User Interface\n\n```ui\n+--------------------------------------------+\n|dialog_header...............................|\n+--------------------------------------------+\n|                                            |\n|  message.................................  |\n|  ........................................  |\n|                                            |\n|   ok_btn............  cancel_btn........   |\n|                                            |\n+--------------------------------------------+\n```\n'
    _mcp_agent_metadata = {'window': {'description': 'Message Box UI source.'}, 'elements': {'dialog_header': {'role': 'text', 'description': 'Message', 'expose': True}, 'message': {'role': 'text', 'description': 'message', 'expose': True}, 'ok_btn': {'role': 'action', 'description': 'OK', 'expose': True}, 'cancel_btn': {'role': 'action', 'description': 'Cancel', 'expose': True}}}
    _mcp_app_tools = {}
